...
const ContactSection = () => {
  return <div className="glass-panel rounded-2xl p-8 w-fit mx-auto animate-fade-in">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            ...
            <a href="mailto:ani.hovhannisyan@rearmenia.com" className="text-xs md:text-sm md:font-small hover:text-rearmenia-orange transition-colors truncate block overflow-hidden text-ellipsis">
